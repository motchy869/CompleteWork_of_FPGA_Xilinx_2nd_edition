...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/hdl/blink.sv"]"\
 "[file normalize "$origin_dir/xdc/blink.xdc"]"\
  ]
  foreach ifile $files {
...
set file "$origin_dir/hdl/blink.sv"
...
set file "[file normalize "$origin_dir/xdc/blink.xdc"]"
set file_added [add_files -norecurse -fileset $obj [list $file]]
set file "$origin_dir/xdc/blink.xdc"
set file [file normalize $file]
