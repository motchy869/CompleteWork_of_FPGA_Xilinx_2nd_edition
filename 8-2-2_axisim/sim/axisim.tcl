...
#
# axisim.tcl: Tcl script for re-creating project 'axisim'
#
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/hdl/axisim_tb.sv"]"\
  ]
  foreach ifile $files {
  ...
  set paths [list \
 "[file normalize "$origin_dir/[file normalize "$origin_dir/../ips/aximaster_ip"]"]"\
...
if { $obj != {} } {
   set_property "ip_repo_paths" "[file normalize "$origin_dir/../ips/aximaster_ip"] [file normalize "$origin_dir/../../../Digilent-vivado-library"] d:/workspace/genPur/common" $obj
...
set file "$origin_dir/hdl/axisim_tb.sv"
...
set obj [get_filesets sim_1]
set_property -name "top" -value "axisim_tb" -objects $obj
...
proc cr_bd_design_1 { parentCell } {
  ...
  xilinx.com:user:axi_master:1.0\
  "
  ...
  connect_bd_intf_net -intf_net axi_master_0_M_AXI [get_bd_intf_pins axi_master_0/M_AXI] [get_bd_intf_pins axi_vip_0/S_AXI]

  # Create port connections
  connect_bd_net -net ACLK_0_1 [get_bd_ports ACLK] [get_bd_pins axi_vip_0/aclk] [get_bd_pins axi_master_0/ACLK]
  connect_bd_net -net ARESETN_0_1 [get_bd_ports ARESETN] [get_bd_pins axi_vip_0/aresetn] [get_bd_pins axi_master_0/ARESETN]
  connect_bd_net -net axi_master_0_ERROR [get_bd_pins axi_master_0/ERROR] [get_bd_ports ERROR]
