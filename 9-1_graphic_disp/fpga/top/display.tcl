...
#
# display.tcl: Tcl script for re-creating project 'display'
#
...
proc checkRequiredFiles { origin_dir} {
 ...
 "[file normalize "$origin_dir/[file normalize "$origin_dir/../display/display_ip"]"]"\
...
if { $obj != {} } {
   set_property "ip_repo_paths" "[file normalize "$origin_dir/../../../../Digilent-vivado-library"] [file normalize "$origin_dir/../display/display_ip"] d:/workspace/genPur/common" $obj
...
\
  ...
  connect_bd_net -net display_0_FIFO_OVERFLOW [get_bd_pins display_0/FIFO_OVERFLOW] [get_bd_pins xlconcat_0/In0]
  connect_bd_net -net display_0_FIFO_UNDERFLOW [get_bd_pins display_0/FIFO_UNDERFLOW] [get_bd_pins xlconcat_0/In1]
