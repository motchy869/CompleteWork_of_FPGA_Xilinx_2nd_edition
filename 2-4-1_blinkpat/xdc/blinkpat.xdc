...
set_input_delay -clock sys_clk_pin -max 1.0 [get_ports { BTN[0] }]; # dummy delay
set_input_delay -clock sys_clk_pin -min 0.0 [get_ports { BTN[0] }]; # dummy delay
set_false_path -from [get_ports { BTN[0] }] -to [get_pins {debounce_inst/ff1*/D}];
