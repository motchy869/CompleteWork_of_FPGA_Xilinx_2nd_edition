...
#
# blinkpat.tcl: Tcl script for re-creating project 'blinkpat'
#
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/hdl/debounce.sv"]"\
 "[file normalize "$origin_dir/hdl/blinkpat.sv"]"\
 "[file normalize "$origin_dir/xdc/blinkpat.xdc"]"\
 "[file normalize "$origin_dir/blinkpat.srcs/utils_1/imports/synth_1/blinkpat.dcp"]"\
  ]
  foreach ifile $files {
...
set file "hdl/debounce.sv"
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "SystemVerilog" -objects $file_obj

set file "hdl/blinkpat.sv"
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "SystemVerilog" -objects $file_obj
...
set_property -name "top" -value "blinkpat" -objects $obj
...
set file "[file normalize "$origin_dir/xdc/blinkpat.xdc"]"
set file_added [add_files -norecurse -fileset $obj [list $file]]
set file "xdc/blinkpat.xdc"
...
set obj [get_runs synth_1]
set_property -name "incremental_checkpoint" -value "$proj_dir/blinkpat.srcs/utils_1/imports/synth_1/blinkpat.dcp" -objects $obj
