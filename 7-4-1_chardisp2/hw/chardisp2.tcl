...
#
# chardisp2.tcl: Tcl script for re-creating project 'chardisp2'
#
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/xdc/chardisp2.xdc"]"\
  ]
  foreach ifile $files {
...
if { $obj != {} } {
   set_property "ip_repo_paths" "[file normalize "$origin_dir/../../../Digilent-vivado-library"] [file normalize "$origin_dir/../../common"] [file normalize "$origin_dir/ips"]" $obj
...
set file "[file normalize "$origin_dir/xdc/chardisp2.xdc"]"
set file_added [add_files -norecurse -fileset $obj [list $file]]
set file "$origin_dir/xdc/chardisp2.xdc"
...
\
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins ps7_0_axi_periph/M00_AXI] [get_bd_intf_pins chardisp_ip_0/s00_axi]
  ...
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins rst_ps7_0_100M/peripheral_aresetn] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins chardisp_ip_0/s00_axi_aresetn]

  # Create address segments
  assign_bd_address -offset 0x40000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs chardisp_ip_0/s00_axi/reg0] -force
...
set obj [get_runs synth_1]
set_property -name "incremental_checkpoint" -value "$proj_dir/chardisp2.srcs/utils_1/imports/synth_1/design_1_wrapper.dcp" -objects $obj
