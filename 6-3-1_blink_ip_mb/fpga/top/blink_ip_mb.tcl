...
#
# blink_ip_mb.tcl: Tcl script for re-creating project 'blink_ip_mb'
#
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/xdc/blink_ip_mb.xdc"]"\
  ]
  foreach ifile $files {
 ...
 "[file normalize "$origin_dir/[file normalize "$origin_dir/../../../7-1_blink_ip_zq/myip_1_0"]"]"\
...
set _xil_proj_name_ "blink_ip_mb"
...
set script_file "blink_ip_mb.tcl"
...
if { $obj != {} } {
   set_property "ip_repo_paths" "[file normalize "$origin_dir/../../../../Digilent-vivado-library"] [file normalize "$origin_dir/../../../7-1_blink_ip_zq/myip_1_0"] d:/workspace/genPur/common" $obj
...
set file "[file normalize "$origin_dir/xdc/blink_ip_mb.xdc"]"
set file_added [add_files -norecurse -fileset $obj [list $file]]
set file "$origin_dir/xdc/blink_ip_mb.xdc"
...
\
  ...
  connect_bd_net -net rst_clk_wiz_1_100M_peripheral_aresetn [get_bd_pins rst_clk_wiz_1_100M/peripheral_aresetn] [get_bd_pins microblaze_0_axi_periph/ARESETN] [get_bd_pins microblaze_0_axi_periph/S00_ARESETN] [get_bd_pins microblaze_0_axi_periph/M00_ARESETN] [get_bd_pins mdm_1/S_AXI_ARESETN] [get_bd_pins myip_0/s00_axi_aresetn] [get_bd_pins microblaze_0_axi_periph/M01_ARESETN]
...
set obj [get_runs synth_1]
set_property -name "incremental_checkpoint" -value "$proj_dir/blink_ip_mb.srcs/utils_1/imports/synth_1/design_1_wrapper.dcp" -objects $obj
