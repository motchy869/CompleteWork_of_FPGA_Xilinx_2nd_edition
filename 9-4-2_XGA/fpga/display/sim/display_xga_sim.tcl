...
#
# display_xga_sim.tcl: Tcl script for re-creating project 'display_xga_sim'
#
...
set _xil_proj_name_ "display_xga_sim"
...
set script_file "display_xga_sim.tcl"
...
# display_xga_wrap
  ...
  set XGA_DE [ create_bd_port -dir O XGA_DE ]
  set XGA_HS [ create_bd_port -dir O XGA_HS ]
  ...
  # Create instance: display_xga_wrap_0, and set properties
  set block_name display_xga_wrap
  set block_cell_name display_xga_wrap_0
  if { [catch {set display_xga_wrap_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $display_xga_wrap_0 eq "" } {
  ...
  connect_bd_net -net display_xga_wrap_0_FIFO_OVERFLOW [get_bd_pins display_xga_wrap_0/FIFO_OVERFLOW] [get_bd_ports FIFO_OVERFLOW]
  connect_bd_net -net display_xga_wrap_0_FIFO_UNDERFLOW [get_bd_pins display_xga_wrap_0/FIFO_UNDERFLOW] [get_bd_ports FIFO_UNDERFLOW]
  connect_bd_net -net display_xga_wrap_0_PCK [get_bd_pins display_xga_wrap_0/PCK] [get_bd_ports PCK]
  connect_bd_net -net display_xga_wrap_0_VBLANK [get_bd_pins display_xga_wrap_0/VBLANK] [get_bd_ports VBLANK]
  connect_bd_net -net display_xga_wrap_0_XGA_B [get_bd_pins display_xga_wrap_0/XGA_B] [get_bd_ports XGA_B]
  connect_bd_net -net display_xga_wrap_0_XGA_DE [get_bd_pins display_xga_wrap_0/XGA_DE] [get_bd_ports XGA_DE]
  connect_bd_net -net display_xga_wrap_0_XGA_G [get_bd_pins display_xga_wrap_0/XGA_G] [get_bd_ports XGA_G]
  connect_bd_net -net display_xga_wrap_0_XGA_HS [get_bd_pins display_xga_wrap_0/XGA_HS] [get_bd_ports XGA_HS]
  connect_bd_net -net display_xga_wrap_0_XGA_R [get_bd_pins display_xga_wrap_0/XGA_R] [get_bd_ports XGA_R]
  connect_bd_net -net display_xga_wrap_0_XGA_VS [get_bd_pins display_xga_wrap_0/XGA_VS] [get_bd_ports XGA_VS]
