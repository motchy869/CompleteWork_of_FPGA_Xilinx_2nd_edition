...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "DISP_ADDR_WIDTH" -parent ${Page_0}
...
proc update_PARAM_VALUE.DISP_ADDR_WIDTH { PARAM_VALUE.DISP_ADDR_WIDTH } {
	# Procedure called to update DISP_ADDR_WIDTH when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.DISP_ADDR_WIDTH { PARAM_VALUE.DISP_ADDR_WIDTH } {
	# Procedure called to validate DISP_ADDR_WIDTH
	return true
}


proc update_MODELPARAM_VALUE.DISP_ADDR_WIDTH { MODELPARAM_VALUE.DISP_ADDR_WIDTH PARAM_VALUE.DISP_ADDR_WIDTH } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.DISP_ADDR_WIDTH}] ${MODELPARAM_VALUE.DISP_ADDR_WIDTH}
}
