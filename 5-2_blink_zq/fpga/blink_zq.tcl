...
#
# blink_zq.tcl: Tcl script for re-creating project 'blink_zq'
#
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/vivado_project/archive_project_summary.txt"]"\
  ]
  foreach ifile $files {
  ...
  set files [list \
 "[file normalize "$origin_dir/vivado_project/blink_zq.srcs/constrs_1/imports/xdc/blink_zq.xdc"]"\
  ]
  foreach ifile $files {
    if { ![file isfile $ifile] } {
...
set_property -name "board_part_repo_paths" -value "[file normalize "$origin_dir/vivado_project/blink_zq.board"]" -objects $obj
...
set file "[file normalize ${origin_dir}/vivado_project/blink_zq.srcs/constrs_1/imports/xdc/blink_zq.xdc]"
set file_added [add_files -norecurse -fileset $obj [list $file]]
set file "$origin_dir/vivado_project/blink_zq.srcs/constrs_1/imports/xdc/blink_zq.xdc"
...
set obj [get_filesets constrs_1]
set_property -name "target_constrs_file" -value "$orig_proj_dir/blink_zq.srcs/constrs_1/imports/xdc/blink_zq.xdc" -objects $obj
set_property -name "target_ucf" -value "$orig_proj_dir/blink_zq.srcs/constrs_1/imports/xdc/blink_zq.xdc" -objects $obj
...
\
  ...
  connect_bd_net -net axi_gpio_0_gpio_io_o [get_bd_pins axi_gpio_0/gpio_io_o] [get_bd_ports LED_RGB]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins rst_ps7_0_50M/slowest_sync_clk] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_50M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_50M_peripheral_aresetn [get_bd_pins rst_ps7_0_50M/peripheral_aresetn] [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN]
...
set obj [get_runs synth_1]
set_property -name "incremental_checkpoint" -value "$proj_dir/blink_zq.srcs/utils_1/imports/synth_1/design_1_wrapper.dcp" -objects $obj
