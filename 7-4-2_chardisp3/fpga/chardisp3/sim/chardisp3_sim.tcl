...
#
# chardisp3_sim.tcl: Tcl script for re-creating project 'chardisp3_sim'
#
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/../../../../7-4-1_chardisp2/hw/ips/chardisp_ip/src/CGROM/CGROM.xci"]"\
 "[file normalize "$origin_dir/../../../../7-4-1_chardisp2/hw/ips/chardisp_ip/src/VRAM/VRAM.xci"]"\
 "[file normalize "$origin_dir/../../../../7-4-1_chardisp2/hw/ips/chardisp_ip/hdl/gen1HzClk.sv"]"\
 "[file normalize "$origin_dir/../../../../7-4-1_chardisp2/hw/ips/chardisp_ip/hdl/pckgen.sv"]"\
 "[file normalize "$origin_dir/../../../../7-4-1_chardisp2/hw/ips/chardisp_ip/hdl/vga_param.svh"]"\
 "[file normalize "$origin_dir/../../../../7-4-1_chardisp2/hw/ips/chardisp_ip/hdl/syncgen.sv"]"\
 "[file normalize "$origin_dir/../hdl/chardisp.sv"]"\
 "[file normalize "$origin_dir/../../../../7-4-1_chardisp2/hw/ips/chardisp_ip/romdata/CGDATA.coe"]"\
 "[file normalize "$origin_dir/hdl/chardisp_tb.sv"]"\
 "[file normalize "$origin_dir/../../../../7-4-1_chardisp2/hw/ips/chardisp_ip/hdl/vga_param.svh"]"\
  ]
  foreach ifile $files {
...
set _xil_proj_name_ "chardisp3_sim"
...
set script_file "chardisp3_sim.tcl"
...
set file "$origin_dir/../../../../7-4-1_chardisp2/hw/ips/chardisp_ip/src/CGROM/CGROM.xci"
...
set file "$origin_dir/../../../../7-4-1_chardisp2/hw/ips/chardisp_ip/src/VRAM/VRAM.xci"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "generate_files_for_reference" -value "0" -objects $file_obj
if { ![get_property "is_locked" $file_obj] } {
...
set file "$origin_dir/../../../../7-4-1_chardisp2/hw/ips/chardisp_ip/hdl/gen1HzClk.sv"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "SystemVerilog" -objects $file_obj

set file "$origin_dir/../../../../7-4-1_chardisp2/hw/ips/chardisp_ip/hdl/pckgen.sv"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "SystemVerilog" -objects $file_obj

set file "$origin_dir/../../../../7-4-1_chardisp2/hw/ips/chardisp_ip/hdl/vga_param.svh"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "Verilog Header" -objects $file_obj

set file "$origin_dir/../../../../7-4-1_chardisp2/hw/ips/chardisp_ip/hdl/syncgen.sv"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "SystemVerilog" -objects $file_obj

set file "$origin_dir/../hdl/chardisp.sv"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "SystemVerilog" -objects $file_obj
...
set_property -name "top" -value "chardisp" -objects $obj
...
set file "$origin_dir/hdl/chardisp_tb.sv"
set file [file normalize $file]
...
set obj [get_filesets sim_1]
set_property -name "top" -value "chardisp_tb" -objects $obj
