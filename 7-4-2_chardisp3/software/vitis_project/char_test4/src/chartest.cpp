...
void printLinesToUart(VramController &vramController, const int numLines) {
    for (int i=0; i<numLines; ++i) {
        const VramController::VramEntry entry = vramController.getVramEntry(i);
...
int main() {
    ...
    HdmiPrinter printer(VramController::NUM_ROWS, VramController::NUM_COLS, vramController);
