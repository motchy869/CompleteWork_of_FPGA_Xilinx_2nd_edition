...
#
# Script generated by Vivado on Sat May 20 21:49:47 +0900 2023
...
#
# Usage        : CGROM.sh
#                CGROM.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                CGROM.sh [-reset_run]
#                CGROM.sh [-reset_log]
#                CGROM.sh [-help]
#
...
#                script (type 'CGROM.sh -help' for more information).
#
...
# script info
echo -e "CGROM.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./CGROM.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.CGROM xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.CGROM -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log CGROM_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
Usage: CGROM.sh [-reset_log]\n\
Usage: CGROM.sh [-keep_index]\n\
