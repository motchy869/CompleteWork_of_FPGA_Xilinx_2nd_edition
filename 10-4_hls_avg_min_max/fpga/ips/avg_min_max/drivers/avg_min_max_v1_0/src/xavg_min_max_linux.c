...
typedef struct {
    ...
    XAvg_min_max_uio_map maps[ MAX_UIO_MAPS ];
} XAvg_min_max_uio_info;

/***************** Variable Definitions **************************************/
static XAvg_min_max_uio_info uio_info;
...
static int uio_info_read_name(XAvg_min_max_uio_info* info) {
    char file[ MAX_UIO_PATH_SIZE ];
    sprintf(file, "/sys/class/uio/uio%d/name", info->uio_num);
    return line_from_file(file, info->name);
}

static int uio_info_read_version(XAvg_min_max_uio_info* info) {
    char file[ MAX_UIO_PATH_SIZE ];
    sprintf(file, "/sys/class/uio/uio%d/version", info->uio_num);
    return line_from_file(file, info->version);
}

static int uio_info_read_map_addr(XAvg_min_max_uio_info* info, int n) {
    int ret;
    char file[ MAX_UIO_PATH_SIZE ];
...
static int uio_info_read_map_size(XAvg_min_max_uio_info* info, int n) {
    int ret;
    char file[ MAX_UIO_PATH_SIZE ];
...
int XAvg_min_max_Initialize(XAvg_min_max *InstancePtr, const char* InstanceName) {
	XAvg_min_max_uio_info *InfoPtr = &uio_info;
