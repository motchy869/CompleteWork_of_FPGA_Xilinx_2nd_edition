...
#
# chardisp_mb.tcl: Tcl script for re-creating project 'chardisp_mb'
#
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/xdc/chardisp3.xdc"]"\
  ]
  foreach ifile $files {
 ...
 "[file normalize "$origin_dir/[file normalize "$origin_dir/../../7-4-2_chardisp3/fpga/top/ips"]"]"\
...
set _xil_proj_name_ "chardisp_mb"
...
set script_file "chardisp_mb.tcl"
...
if { $obj != {} } {
   set_property "ip_repo_paths" "[file normalize "$origin_dir/../../../Digilent-vivado-library"] [file normalize "$origin_dir/../../7-4-2_chardisp3/fpga/top/ips"] d:/workspace/genPur/common" $obj
...
set file "[file normalize "$origin_dir/xdc/chardisp3.xdc"]"
set file_added [add_files -norecurse -fileset $obj [list $file]]
set file "$origin_dir/xdc/chardisp3.xdc"
...
proc cr_bd_design_1 { parentCell } {
  ...
  xilinx.com:user:chardisp_ip:1.0\
...
\
  ...
  set chardisp_ip_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:chardisp_ip:1.0 chardisp_ip_0 ]
  ...
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_M01_AXI [get_bd_intf_pins microblaze_0_axi_periph/M01_AXI] [get_bd_intf_pins chardisp_ip_0/s00_axi]
  ...
  connect_bd_net -net microblaze_0_Clk [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins microblaze_0/Clk] [get_bd_pins microblaze_0_axi_periph/ACLK] [get_bd_pins microblaze_0_axi_periph/S00_ACLK] [get_bd_pins microblaze_0_axi_periph/M00_ACLK] [get_bd_pins microblaze_0_local_memory/LMB_Clk] [get_bd_pins mdm_1/S_AXI_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk] [get_bd_pins chardisp_ip_0/s00_axi_aclk] [get_bd_pins microblaze_0_axi_periph/M01_ACLK]
  ...
  connect_bd_net -net rst_ps7_0_100M_bus_struct_reset [get_bd_pins rst_ps7_0_100M/bus_struct_reset] [get_bd_pins microblaze_0_local_memory/SYS_Rst]
  connect_bd_net -net rst_ps7_0_100M_mb_reset [get_bd_pins rst_ps7_0_100M/mb_reset] [get_bd_pins microblaze_0/Reset]
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins rst_ps7_0_100M/peripheral_aresetn] [get_bd_pins microblaze_0_axi_periph/ARESETN] [get_bd_pins microblaze_0_axi_periph/S00_ARESETN] [get_bd_pins microblaze_0_axi_periph/M00_ARESETN] [get_bd_pins mdm_1/S_AXI_ARESETN] [get_bd_pins chardisp_ip_0/s00_axi_aresetn] [get_bd_pins microblaze_0_axi_periph/M01_ARESETN]

  # Create address segments
  assign_bd_address -offset 0x00010000 -range 0x00010000 -target_address_space [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs chardisp_ip_0/s00_axi/reg0] -force
...
set obj [get_runs synth_1]
set_property -name "incremental_checkpoint" -value "$proj_dir/chardisp_mb.srcs/utils_1/imports/synth_1/design_1_wrapper.dcp" -objects $obj
